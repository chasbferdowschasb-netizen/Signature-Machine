...
- Results: test_visual_results_v06_1.json
- Debug:   test_debug_v06_1/
"""
...
def main() -> None:
    ...
    debug_dir = Path("test_debug_v06_1")
    results_file = Path("test_visual_results_v06_1.json")

    analyzer = DeepVisualAnalyzer(debug=True, debug_dir=debug_dir)
    print(f"Analyzer module: {__import__('visual_analyzer_v06_1').__file__}")
    ...
    print()
    print("=" * 70)
    print("VISUAL ANALYZER V0.6.1 — EXACT 20 SAMPLE TEST")
    print("=" * 70)
