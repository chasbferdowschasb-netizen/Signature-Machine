...
- Results: test_visual_results_v05.json
- Debug:   test_debug_v05/
"""
...
from visual_analyzer_v05 import DeepVisualAnalyzer
...
def main() -> None:
    ...
    debug_dir = Path("test_debug_v05")
    results_file = Path("test_visual_results_v05.json")
    ...
    print()
    print("=" * 70)
    print("VISUAL ANALYZER V0.5 — EXACT 20 SAMPLE TEST")
    print("=" * 70)
